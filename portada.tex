...
% :FACER: 0 Meter o texto este nun macro e definilo en cada revista
% En el documento8
\begin{tikzpicture}[remember picture, overlay]
    % Imagen 1 (superpuesta)
    \node[
        anchor=south west, xshift=0.9cm, yshift=3.cm,
        fill  =gray,
    ...
    {\normalsize \textcolor{white}{{\textbf{Primeira pedra da} \\[2pt] \textbf{facultade de física 1981.}}}};
