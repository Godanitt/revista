...
redor da súa estadía na nosa Facultade de Física da USC. A revista \textit{Momentum}
recolle o testemuño de anteriores iniciativas similares que existiron na
Facultade, nomeadamente as revistas A \textit{Gota de Millikan} e o \textit{Físical Interviú} que
...
constitúen unha ponte que conecta varias xeracións de físicos e físicas
...
atopar profesorado de sobra coñecido por vós, algún xa xubilado. A \textit{Gota de Millikan}
 adicaba unha sección ao xadrez, unha das actividades favoritas do
...
mans ou par de bicos tras unha presentación e que se ía consolidando co contacto
periódico pois nin o teléfono fixo estaba ao alcance de todos.

\textit{Físical Interviú} aproximábase máis a un boletín. O seu formato era máis
...
con colaboracións puntuais. En \textit{Físical Interviú} tratábanse temas relacionados
...
encontros do alumnado cos Premios Nobel, grazas ao programa ConCiencia; as
...
co artigo \textit{Mi mamá es investigadora} no ano 2008 e a sección ConCiencia de Muller
...
O contexto no que xorde \textit{Momentum} é distinto ao doutras épocas, pois as formas
...
intercambio estruturado de ideas. \textit{Momentum}, pola súa natureza como publicación
...
A nosa experiencia dinos que o éxito de \textit{Momentum} será directamente proporcional
...
poderán botar unha ollada ás páxinas de \textit{Momentum} e descubrir como eran os
...
intelectuais estimulantes. Unha publicación como \textit{Momentum} pode servir para
...
nosa contorna. \textit{Momentum} pode axudar a cambiar iso, ofrecendo un escaparate para
...
Ademais, \textit{Momentum} pode servir como vehículo para a divulgación científica
...
amplo e a espertar vocacións entre os futuros estudantes. \textit{Momentum} pode ser
...
acudindo ao persoal da Facultade. \textit{Momentum} pode ser un espazo onde estas
...
En definitiva, \textit{Momentum} será aquilo que o estudantado decida que sexa. A súa
...
contidos. Estamos seguros de que \textit{Momentum} se converterá nun elemento
