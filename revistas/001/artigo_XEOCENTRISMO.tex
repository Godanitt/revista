...
{historia}
{Unha pequena historia do modelo xeocentrista, dos seus defensores e detractores, dende os seus inicios gregos ata o seu ocaso na Idade Media.}
{Si}
...
\begin{center}
    ...
    \label{fig:epiciclo}
    \captionof{figure}{{\small Órbita con epiciclos, que Kepler chamaba ``pretzels''.}}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{{\small Á dereita, modelo da ecuante de Ptolomeo. Imaxes de Wikipedia.}}
\end{center}
