...
<<\textit{verdade obxectiva}>> do Universo, e que con ela poderemos dar resposta a
...
\begin{center}
    ...
    \captionof{figure}{Representación gráfica dun skyrmión,onde o número de buracos se corresponde coa súa carga topolóxica.}
\end{center}
